...
module.exports.handleReply = async ({ event, api, handleReply, Currencies, getText }) => {
    ...
    var rddaa = ['sau này chịu khó cần cù thì bù siêng năng chỉ có làm thì mới có ăn còn cái loại không làm mà đòi có ăn thì ăn đb nhá ăn cức']; //random công việc khi đào đá
